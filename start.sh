...
db_ans=$(mysql -h 10.0.15.4 -P 3307 -u root -p123456 -e "show databases;")
check_exist=$(echo $db_ans | grep goip)
if [[ -z $check_exist ]]; then
    echo "No database"
    mysql -h 10.0.15.4 -P 3307 -u root -p123456 -e "CREATE DATABASE goip;"
    mysql -h 10.0.15.4 -P 3307 -u root -p123456 goip < ./goip.sql
else
